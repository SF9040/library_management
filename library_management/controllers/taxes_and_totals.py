    ...
    if not self.discount_amount_applied:
        for item in self._items:
            ...
            if (
                ...
                if item.get('is_customizable') is not None and item.is_customizable == 1 and item.customizable_uom == 'LxW':
                ...
                if item.get('is_customizable') is not None and item.is_customizable == 1 and item.customizable_uom == 'Wt':
