    ...
    if not self.discount_amount_applied:
        for item in self._items:
            ...
            if (
                ...
                if item.is_customizable and item.is_customizable == 1 and item.customizable_uom == 'LxW':
...
def calculate_total_net_weight(self):
    if self.doc.meta.get_field("total_net_weight"):
        ...
        for d in self._items:
            if d.total_weight:
                if d.is_customizable and d.is_customizable == 1 and d.customizable_uom == 'LxW':
